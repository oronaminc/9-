...
def preprocess(load_ws, text):
    ...
    max_row = 806
    load_ws.cell(row=max_row+1, column=5).value = '하다'
    load_ws.cell(row=max_row+2, column=5).value = '다'
    load_ws['E1'] = text
...
load_wb2 = load_workbook("adjective.xlsx", data_only=True)
load_ws = load_wb['Raw']
